# FAIR Evidence Audits for Phenotyping Data

## Why this capability exists

FAIR describes properties that improve findability, accessibility,
interoperability, and reusability. OmniPhenoR therefore reports evidence
and missing elements rather than producing a misleading certification
score.
...
- [`pheno_license()`](https://wep69.github.io/OmniPhenoR/reference/pheno_license.md)
- [`pheno_access_policy()`](https://wep69.github.io/OmniPhenoR/reference/pheno_access_policy.md)
- [`pheno_to_jsonld()`](https://wep69.github.io/OmniPhenoR/reference/pheno_to_jsonld.md)
- [`pheno_publish_check()`](https://wep69.github.io/OmniPhenoR/reference/pheno_publish_check.md)

## Conceptual workflow

![Conceptual 0.5.0
workflow](../inst/extdata/vignette-results/figures/v38-fair-data-and-metadata.png)
...
exp <- pheno_experiment(
  "cotton_rgb_2026",
  "Cotton RGB phenotyping dataset",
  metadata = list(
    description = "Repeated RGB canopy phenotyping",
...
#>  2 F2        TRUE     pass       Add rich study metadata                        
...
subset(fair, status == "incomplete")
#> # A tibble: 6 × 4
#>   principle evidence status     recommendation                                  
#>   <chr>     <lgl>    <chr>      <chr>                                           
#> 1 F3        FALSE    incomplete Link metadata to registered files               
#> 2 I1        FALSE    incomplete Use machine-readable structured metadata        
#> 3 I2        FALSE    incomplete Use resolvable controlled vocabulary identifiers
#> 4 I3        FALSE    incomplete Record qualified relations/lineage              
#> 5 R1        FALSE    incomplete Provide sufficient domain attributes            
#> 6 R1.3      FALSE    incomplete Use community standards such as MIAPPE/BrAPI wh…

# Optional machine-readable discovery metadata:
# pheno_to_jsonld(exp)
```
...
#> 1 file_ab883f… trai… phen… csv       38 2bb75… NA             NA      2026-08-2…
pheno_verify_manifest(portable)
#> # A tibble: 1 × 6
#>   file_id           path     exists checksum_ok current_sha256 registered_sha256
#>   <chr>             <chr>    <lgl>  <lgl>       <chr>          <chr>            
#> 1 file_ab883f8c68ec traits.… TRUE   TRUE        2bb75ff315e6b… 2bb75ff315e6b251…
```
