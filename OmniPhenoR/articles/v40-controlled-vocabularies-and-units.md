# Observed Variables, Controlled Vocabulary Links, and Units

## Why this capability exists

A phenotype variable should identify what was measured, how it was
measured, how the values are represented, and in which unit. Trait,
method, scale, and unit are therefore stored separately.
...
- [`pheno_variable()`](https://wep69.github.io/OmniPhenoR/reference/pheno_variable.md)
- [`pheno_unit_validate()`](https://wep69.github.io/OmniPhenoR/reference/pheno_unit_validate.md)
- [`pheno_germplasm()`](https://wep69.github.io/OmniPhenoR/reference/pheno_germplasm.md)
- [`pheno_sensor()`](https://wep69.github.io/OmniPhenoR/reference/pheno_sensor.md)
- [`pheno_protocol()`](https://wep69.github.io/OmniPhenoR/reference/pheno_protocol.md)
- [`pheno_register()`](https://wep69.github.io/OmniPhenoR/reference/pheno_register.md)

## Conceptual workflow

![Conceptual 0.5.0
workflow](../inst/extdata/vignette-results/figures/v40-controlled-vocabularies-and-units.png)
...
cover <- pheno_variable(
  variable_id = "cc_exg",
  trait = "green canopy cover",
  method = "ExG + Otsu segmentation",
  scale = "proportion",
  unit = "1",
  ontology = "Crop Ontology",
  accession = "example_accession"
)

height <- pheno_variable(
  "height_cm", "plant height", "field ruler",
  "continuous", "cm"
)

pheno_unit_validate(c("1", "cm", "cm2", "degree-day", "unknown"))
#> # A tibble: 5 × 3
...
#> 2 cm         NA        TRUE      
#> 3 cm2        NA        TRUE      
#> 4 degree-day NA        TRUE      
#> 5 unknown    NA        FALSE

exp <- pheno_experiment("semantic_demo")
exp <- pheno_register(exp, "variable", cover)
exp <- pheno_register(exp, "variable", height)
exp <- pheno_register(exp, "sensor",
  pheno_sensor("RGB1", "RGB camera", model = "Example camera"))
exp <- pheno_register(exp, "protocol",
  pheno_protocol("SEG1", "Canopy segmentation", version = "1.0"))
exp$variables
#>   variable_id              trait                  method      scale unit
#> 1      cc_exg green canopy cover ExG + Otsu segmentation proportion    1
#> 2   height_cm       plant height             field ruler continuous   cm
#>        ontology         accession
#> 1 Crop Ontology example_accession
#> 2          <NA>              <NA>
```
...
#> 1 file_d98df5… trai… phen… csv       38 2bb75… NA             NA      2026-08-2…
pheno_verify_manifest(portable)
#> # A tibble: 1 × 6
#>   file_id           path     exists checksum_ok current_sha256 registered_sha256
#>   <chr>             <chr>    <lgl>  <lgl>       <chr>          <chr>            
#> 1 file_d98df52a2411 traits.… TRUE   TRUE        2bb75ff315e6b… 2bb75ff315e6b251…
```
