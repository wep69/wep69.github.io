# Summarize posterior effect indices

Reports direction probability and a simple response-SD standardized
effect for location coefficients. The standardized quantity is
descriptive and does not replace a scientifically defined meaningful
threshold.

## Usage

``` r
bayes_effects(fit, level = 0.95)
```
...
- fit:
  ...
  A \`bayes_fit\` with posterior draws.
...
#>   p_negative    pd standardized_median
#> 1      0.000 1.000          15.4657589
#> 2      0.026 0.974           0.8423128
#> 3      0.000 1.000           1.7311894
#> 4      0.000 1.000           1.7298805
#> 5      0.016 0.984           0.8678802
#> 6      0.834 0.834          -0.3667894
#>                                                                              effect_index_note
#> 1 Median divided by observed response SD; use scientific thresholds for substantive decisions.
#> 2 Median divided by observed response SD; use scientific thresholds for substantive decisions.
#> 3 Median divided by observed response SD; use scientific thresholds for substantive decisions.
#> 4 Median divided by observed response SD; use scientific thresholds for substantive decisions.
#> 5 Median divided by observed response SD; use scientific thresholds for substantive decisions.
#> 6 Median divided by observed response SD; use scientific thresholds for substantive decisions.

# Example 3: 90 percent intervals
bayes_effects(f1, level = 0.90)
#>          parameter       mean     median         sd       lower     upper
